...
<% 
 if(null == session.getAttribute("userId")){ 
  String address = "/wp-content/portal/SessionExpired.jsp?page=sales/salesOrder";
 ...
 <div class="wrapper">
  ...
  <jsp:include page="../inc.jsp" />
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          ...
          <li><a href="<%=request.getContextPath()%>/wp-content/portal/sales.jsp">Sales</a></li>
	          	<li class="active"><a href="<%=request.getContextPath()%>/wp-content/portal/salesOrder.jsp">Sales Order</a></li>
          </ol>
        </section>
           ...
           <form action="<%=request.getContextPath()%>/controller" method="get">
             ...
             <!-- ===============  -->
											...
											<div class="alert  alert-dismissable alert-success">
												<i class="fa fa-fw fa-check"></i>&nbsp;SalesQuotation Added
												successfully.
           ...
           <legend>General</legend>
		        ...
		        <div class="form-group">
		          	<div class="row">
                        	...
                        	<div class="col-xs-4"> 
                        		  <input type="text" class="form-control" placeholder="Sales Order No" name="Sales Order No" id="Sales Order No">
		  					</div>
	...
	<div class="input-group">
		...
		<input class="datepicker" type="text" name="date" placeholder="Sales Order Date"  style="width:275px"  name="Sales Order Date" id="Sales Order Date">
  	 </div>
</div>
                        	...
                        	<div class="col-xs-4"> 
                        		<input type="text" class="form-control" placeholder="Quotation No"  name="QuotationNo" id="QuotationNo" value=<%=request.getParameter("qn")%>>
                        		</div>
		       		    </div>
		           </div>		 
             ...
             <div class="form-group">
                    ...
                    <div class="col-xs-4"> 
                 					 ...
                 					 <input type="text" class="form-control" placeholder="Packing List No"  name="Packing List No" id="Packing List No">
	...
	<div class="input-group">
		...
		<input class="datepicker" type="text" name="date" placeholder="Delivery Date" style="width:275px"  name="Delivery Date" id="Delivery Date">
  	 </div>
</div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-xs-4">
		  				   		...
		  				   		<textarea class="form-control" rows="1" placeholder="ItemName"  name="ItemName" id="ItemName" disabled></textarea>
			            </select>
                    </div>
               ...
               <div class="box-footer">
                     <input type="hidden" value="doAddSalesOrder" name="actionCode" />
                     <input type="hidden" value="Sales/salesOrder" name="page" />
 ...
 <!-- Add the sidebar's background. This div must be placed
    ...
    <script>
	  ...
	  $.ajax({
			...
			type:"POST",
			url : '../../../controller?actionCode=GetDetailsFromQuo',
			data : {
      ...
      $(document).ready(function () {
          $('.salesOrder').addClass('active');
          $('.Sales').addClass('active');
      });
      $('#QuotationNo').blur(function() {
