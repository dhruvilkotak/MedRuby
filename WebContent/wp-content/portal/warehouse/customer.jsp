...
<html>
 ...
 if(null == session.getAttribute("userId")){ 
  String address = "/wp-content/portal/SessionExpired.jsp?page=warehouse/customer";
        ...
        <section class="content-header">
          ...
          <ol class="breadcrumb">
           ...
           <li><a href="<%=request.getContextPath()%>/wp-content/portal/warehouse.jsp">Warehouse</a></li>
          	<li class="active"><a href="<%=request.getContextPath()%>/wp-content/portal/stockDetails.jsp">Customer Details</a></li>
          </ol>
        </section>
        ...
        <section class="content">
           <div class="container">
			...
			<div class="alert alert-dismissable alert-success">
					<i class="fa fa-fw fa-check"></i>&nbsp; Customer Details added successfully.
           ...
           <legend>Customer Details</legend>
                  ...
                  <div class="form-group">
                    ...
                    <input type="hidden" value="doAddCustomerDetails" name="actionCode" />
                    <input type="hidden" value="warehouse/customer" name="page" />
