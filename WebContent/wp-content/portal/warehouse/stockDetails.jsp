...
<html>
 ...
 if(null == session.getAttribute("userId")){ 
  String address = "/wp-content/portal/SessionExpired.jsp?page=warehouse/stockDetails";
        ...
        <section class="content-header">
          ...
          <ol class="breadcrumb">
           ...
           <li><a href="<%=request.getContextPath()%>/wp-content/portal/warehouse.jsp">Warehouse</a></li>
          	<li class="active"><a href="<%=request.getContextPath()%>/wp-content/portal/stockDetails.jsp">Stock Details</a></li>
          </ol>
        </section>
        ...
        <section class="content">
           <div class="container">
			...
			<div class="alert alert-dismissable alert-success">
					<i class="fa fa-fw fa-check"></i>&nbsp; Stock Details added successfully.
           ...
           <legend>Item Details</legend>
		          ...
		          <div class="form-group">
		          	<div class="row">
                        	...
                        	<div class="col-xs-4"> 
                        		  <input type="text" name="itemId" class="form-control" placeholder="Item Code">
		  					</div>
		  					
                        	<div class="col-xs-4"> 
                        		  <input type="text" name="itemRefNumber" class="form-control" placeholder="Item Reference Code">
		  					</div>
		  					
		  					<div class="col-xs-4"> 
                        		  <input type="text" name="itemType" class="form-control" placeholder="Item Type">
		  					</div>
                  ...
                  <div class="form-group">
                  	...
                  	<div class="col-xs-4"> 
                        	...
                        	<div class="col-xs-4"> 
		                    <select name="inventoryCategory" class="form-control">
		                    	<option value="" selected disabled>Inventory Category</option>
		          ...
		          <div class="form-group">
		          	<div class="row">
		          	<div class="col-xs-4"> 
                        		  <input type="text" name="openingStock" class="form-control" placeholder="Opening Stock">
		  					</div>
		  					
                        	<div class="col-xs-4"> 
                        		  <input type="text" name="currentStock" class="form-control" placeholder="Current Stock">
		  					</div>
		  					<div class="col-xs-4"> 
            		...
            		<div class="form-group">
                  	<div class="row">
                        	...
                        	<div class="col-xs-4"> 
                        		  <input type="text" name="rejectedStock"  class="form-control" placeholder="Rejected Stock">
		  					</div>
		  					
                        	<div class="col-xs-4"> 
                        		  <input type="text" name="reserveStock" class="form-control" placeholder="Reserve Stock">
		  					</div>
		  					<div class="col-xs-4"> 
                        		  <input type="text" name="minimumOrderQty" class="form-control" placeholder="Min Order Qty">
		  					</div>
            	...
            	<div class="form-group">
                    ...
                    <input type="hidden" value="doAddStockDetails" name="actionCode" />
                    <input type="hidden" value="warehouse/stockDetails" name="page" />
