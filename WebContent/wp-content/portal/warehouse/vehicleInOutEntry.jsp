...
<html>
 ...
 if(null == session.getAttribute("userId")){ 
  String address = "/wp-content/portal/SessionExpired.jsp?page=warehouse/vehicleInOutEntry";
  ...
  <jsp:include page="../inc.jsp" />
        ...
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            ...
            <li><a href="<%=request.getContextPath()%>/wp-content/portal/warehouse.jsp">Warehouse</a></li>
          	<li class="active"><a href="<%=request.getContextPath()%>/wp-content/portal/vehicleInOutEntry.jsp">Vehicle In Out</a></li>
          </ol>
        </section>
        ...
        <section class="content">
           ...
           <form action="<%=request.getContextPath()%>/controller" method="post">
			...
			<div class="alert alert-dismissable alert-success">
					<i class="fa fa-fw fa-check"></i>&nbsp; Vehicle Entry added successfully.
           ...
           <legend>Gate Keeper Vehicle In Out Entry</legend>
                <!-- Left col -->
		          ...
		          <div class="form-group">
		          	<div class="row">
                        	...
                        	<div class="col-xs-4"> 
                        		  <input type="text" name="entryNumber" class="form-control" placeholder="Vehicle In/Out Entry No">
		  					</div>
		  				
		                    
		       		    <div class="col-xs-4"> 
                        		  <input type="text" name="vehicleNumber" class="form-control" placeholder="Vehicle No">
		  					</div>
		  					<div class="col-xs-4">
							...
							<input class="datepicker" type="text" name="entryDate" placeholder="Date of Entry" style="width: 275px">
  							 </div>
						</div>
		       		    </div>
		           </div>		 
                    ...
                    <div class="form-group">
                      ...
                      <div class="radio">
                        ...
                        <label>
                          <input type="radio" name="toDepartment"  value="Sales" >
  							Sales
                        </label>
                        <label>
                          <input type="radio" name="toDepartment"  value="Purchase">
                          Purchase
                        </label>
                       ...
                       <div class="form-group">
                  	<div class="row">
                      <label class="col-sm-3 control-label">Vehicle Movement Type:</label>
                      <div class="col-xs-3">
                      <div class="radio">
                        <label>
                          <input type="radio" name="vehicleStatus" value="In" >
  							In
                        </label>
                        <label>
                          <input type="radio" name="vehicleStatus" value="Out">
                          Out
                        </label>
                        </div>
                      </div></div></div>
             ...
             <div class="form-group">
		          	<div class="row">
		          	<div class="col-xs-4"> 
                        		  <input type="text" name="gatePassNumber" class="form-control" placeholder="GatePass Number">
		  					</div>
		  					 <div class="col-xs-4">
							<div class="input-group">
							<div class="input-group-addon" >
							...
							<input class="datepicker" type="text" name="gatePassDate" placeholder="GatePass Date" style="width: 275px">
  							 </div>
						</div>
		          	
		          	<div class="col-xs-4"> 
                        		  <input type="text" name="refDocumentNumber" class="form-control" placeholder="Purchase Order Number">
		  					</div>
		    	...
		    	<div class="form-group">
                  	<div class="row">
		  						...
		  						<div class="col-xs-4"> 
		                    <select name="transportName" class="form-control" >
		                    	<option value="" selected disabled>Transport Name</option>
		                        <option>Truck</option>
		                        <option>Tempo</option>
		                        <option>Other</option>
                      	...
                      	<div class="col-xs-4"> 
		                    <select name="enteredBy" class="form-control" >
		                    	<option value="" selected disabled>Entered By</option>
                     ...
                     <div class="box-footer">
                     	<input type="hidden" value="doAddEntry" name="actionCode" />
                     	<input type="hidden" value="warehouse/vehicleInOutEntry" name="page" />
    ...
    <script>
      ...
      $(document).ready(function () {
          $('.vehicleInOutEntry').addClass('active');
